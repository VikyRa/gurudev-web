...
import { clearErrors, sigupuser, userlogin } from '../../../actions';
/**
* @author
* @function UserLogin
**/
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-8 right left shadow">
              <h3 className="mb-2 mt-3 text-center">Member's Login</h3>
              ...
              <form style={{padding:"40px"}} onSubmit={onhandlelogin}>
                <div className="row">
                  ...
                  <div className="col-12">
                    ...
                    <Link to="/user/signup" className="btn btn-md form-control" style={{background:'#e6a708',color: '#fff'}}>Sign Up</Link>
